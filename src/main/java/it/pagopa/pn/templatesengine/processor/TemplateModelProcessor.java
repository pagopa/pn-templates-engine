 ...
 * e popola un oggetto di output tipizzato {@code O} (GENERATED params).
 *
...
public interface TemplateModelProcessor<M, O> {
     ...
     * @param outParams l'oggetto output tipizzato da popolare (accessibile nel template come GENERATED)
     */
