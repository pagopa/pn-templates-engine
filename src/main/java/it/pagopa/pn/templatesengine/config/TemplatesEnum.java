...
public enum TemplatesEnum {
    ...
    NOTIFICATION_AAR_FOR_EMAIL_ANALOG("notificationAarForEmailAnalog"),
    NOTIFICATION_AAR_FOR_EMAIL_DIGITAL("notificationAarForEmailDigital"),
    NOTIFICATION_AAR_FOR_PEC("notificationAarForPec"),
    NOTIFICATION_AAR_FOR_SMS_ANALOG("notificationAarForSmsAnalog"),
    NOTIFICATION_AAR_FOR_SMS_DIGITAL("notificationAarForSmsDigital"),
    ...
    COURTESY_SMS_COMMUNICATION("courtesySmsCommunication"),
    COURTESY_EMAIL_COMMUNICATION_BODY("courtesyEmailCommunicationBody"),
    COURTESY_EMAIL_COMMUNICATION_SUBJECT("courtesyEmailCommunicationSubject");
